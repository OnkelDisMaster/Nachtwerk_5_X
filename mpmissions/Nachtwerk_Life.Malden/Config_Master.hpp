...
/* System Settings */
    ...
    sendtoJail_locations[] = { "cop_spawn_1", "cop_spawn_2", "cop_spawn_3", "cop_spawn_4", "cop_spawn_5", "jail_marker", "sek_spawn", "zentralbank" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    delivery_points[] = { "dp_1", "dp_2", "dp_3", "dp_4", "dp_5", "dp_6", "dp_7", "dp_8", "dp_9", "dp_10", "dp_11", "dp_12"};
