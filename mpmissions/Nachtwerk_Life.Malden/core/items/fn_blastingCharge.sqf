...
if (((nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) || (nearestObject [[12017.795,4363.207,6.050],"Land_Research_house_V1_F"])) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Blast_Exploit"};
