...
/* System Settings */
    ...
    fuel_cost = 800; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    vehicle_purchase_multiplier_MEDIC = .4; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
