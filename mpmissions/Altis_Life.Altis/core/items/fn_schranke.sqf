...
life_action_schrankeDeploy = player addAction["<t color='#ffffff'>Schranke aufstellen</t>",{if(!isNull life_schranke) then {detach life_schranke; life_schranke = ObjNull;}; player removeAction life_action_schrankeDeploy; life_action_schrankeDeploy = nil;},"",999,false,false,"",'!isNull life_schranke'];
...
_schranke enableSimulation true;