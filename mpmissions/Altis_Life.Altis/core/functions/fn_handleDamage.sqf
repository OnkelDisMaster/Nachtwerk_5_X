...
if(!isNull _source) then {
	if(_source != _unit) then {
		...
		if(_projectile in ["B_556x45_dual","B_50BW_Ball_F","B_45ACP_Ball","B_127x108_Ball"] && _curWep in ["arifle_SDAR_F","arifle_ARX_blk_F","srifle_GM6_F","hgun_Pistol_heavy_01_F","hgun_Pistol_heavy_01_snds_F","hgun_Pistol_heavy_01_MRD_F"]) then {
