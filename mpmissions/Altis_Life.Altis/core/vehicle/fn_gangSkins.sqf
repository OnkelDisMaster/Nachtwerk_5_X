        ...
        case "license_civ_pro_rebel": 
            {    
                if (BANK > 50000) then { 
                    switch (_vehicle) do 
                    {
                        case "B_MRAP_01_F": { skinAction = player addAction["Asiimov Hunter Skin", '(vehicle player) setObjectTextureGlobal[0,"skins\car\Hunter_asiimov_0.paa"]; (vehicle player) setObjectTextureGlobal[1,"skins\car\Hunter_asiimov_1.paa"]; player removeAction skinAction;', "",0,false,true,"""",'(vehicle player != player) && ((typeOf (vehicle player)) isEqualTo "B_MRAP_01_F")' ]; BANK = BANK - 50000; hint "Du hast alle möglichen Skins auf dein Fahrzeug geladen\n und dafür 50 000$ bezahlt!";};
                        case "C_SUV_01_F": { skinAction = player addAction["Hyperbeast SUV Skin", '(vehicle player) setObjectTextureGlobal[0,"skins\car\HyperbeastSUV.jpg"]; player removeAction skinAction;', "",0,false,true,"""",'(vehicle player != player) && ((typeOf (vehicle player)) isEqualTo "C_SUV_01_F")' ]; BANK = BANK - 50000; hint "Du hast alle möglichen Skins auf dein Fahrzeug geladen\n und dafür 50 000$ bezahlt!";};
                        case "B_Heli_Light_01_F": { skinAction = player addAction["Hyperbeast Hummingbird Skin", '(vehicle player) setObjectTextureGlobal[0,"skins\air\hyperbird.paa"]; player removeAction skinAction;', "",0,false,true,"""",'(vehicle player != player) && ((typeOf (vehicle player)) isEqualTo "B_Heli_Light_01_F")' ]; BANK = BANK - 50000; hint "Du hast alle möglichen Skins auf dein Fahrzeug geladen\n und dafür 50 000$ bezahlt!";};  
                        case "I_MRAP_03_F": { skinAction = player addAction["Nachtwerk Strider Skin", '(vehicle player) setObjectTextureGlobal[0,"skins\car\nachtwerk_strider.paa"]; player removeAction skinAction;', "",0,false,true,"""",'(vehicle player != player) && ((typeOf (vehicle player)) isEqualTo "I_MRAP_03_F")' ]; BANK = BANK - 50000; hint "Du hast alle möglichen Skins auf dein Fahrzeug geladen\n und dafür 50 000$ bezahlt!";};
                        case "C_Hatchback_01_sport_F": { skinAction = player addAction["Monster Energy Limousine Skin", '(vehicle player) setObjectTextureGlobal[0,"skins\car\hatchback_sport_monster.jpg"]; player removeAction skinAction;', "",0,false,true,"""",'(vehicle player != player) && ((typeOf (vehicle player)) isEqualTo "C_Hatchback_01_sport_F")' ]; BANK = BANK - 50000; hint "Du hast alle möglichen Skins auf dein Fahrzeug geladen\n und dafür 50 000$ bezahlt!";};
                    };
                } else {hint "Du hast nicht genügend Geld auf dem Konto!";};
            };
        case "CopSkins":   
        {
            switch (_vehicle) do
