...
#define Btn6 37455
#define Title 37401
private["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_veh","_tanks","_apex","_normal"];
if(!dialog) then {
...
_tanks = ["I_LT_01_scout_F","I_LT_01_AT_F","I_LT_01_AA_F","I_LT_01_cannon_F","O_MBT_04_cannon_F","O_T_MBT_04_cannon_F","O_MBT_04_command_F","O_T_MBT_04_command_F"];
_apex = ["C_Plane_Civil_01_F","B_T_VTOL_01_vehicle_blue_F","B_T_VTOL_01_vehicle_olive_F","C_Offroad_02_unarmed_F","C_Offroad_02_unarmed_red_F","O_T_VTOL_02_vehicle_hex_F","O_T_LSV_02_unarmed_black_F","O_T_LSV_02_unarmed_arid_F","B_T_LSV_01_unarmed_black_F","B_T_LSV_01_unarmed_olive_F"];
_normal = ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F","B_Heli_Transport_03_F","B_Heli_Transport_03_unarmed_F","O_Heli_Transport_04_F","O_Heli_Transport_04_ammo_F","O_Heli_Transport_04_bench_F","O_Heli_Transport_04_box_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_fuel_F","O_Heli_Transport_04_medevac_F","O_Heli_Transport_04_repair_F","I_Plane_Fighter_04_F","O_Plane_Fighter_02_F","B_Plane_Fighter_01_F", "B_G_Van_02_vehicle_F", "B_G_Van_02_transport_F", "O_G_Van_02_vehicle_F", "O_G_Van_02_transport_F", "I_G_Van_02_vehicle_F", "I_G_Van_02_transport_F", "I_C_Van_02_vehicle_F", "I_C_Van_02_transport_F", "C_IDAP_Van_02_medevac_F", "C_IDAP_Van_02_vehicle_F", "C_IDAP_Van_02_transport_F", "C_Van_02_medevac_F", "C_Van_02_vehicle_F", "C_Van_02_service_F", "C_Van_02_transport_F"];
_fahrzeuge = _apex + _tanks + _normal;
...
switch (playerside) do
{
	case civilian:
	{
		...
		if (typeOf (_curTarget) in _fahrzeuge) then {
