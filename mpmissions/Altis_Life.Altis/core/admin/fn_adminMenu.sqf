...
switch (FETCH_CONST(life_adminlevel)) do
{
    ...
    case 2: {ctrlShow [2904,false];ctrlShow [2905,true];ctrlShow [2906,false];ctrlShow [2907,false];ctrlShow [2908,false];ctrlShow [2909,false];ctrlShow [2910,false];ctrlShow [2911,true];};
    case 3: {ctrlShow [2907,false];ctrlShow [2908,false];ctrlShow [2909,false];ctrlShow [2910,false];ctrlShow [2911,true];};
    case 4: {ctrlShow [2907,true]; ctrlShow [2911,true];};
};
